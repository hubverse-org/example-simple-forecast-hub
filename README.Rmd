...
This repository is designed as an example modeling Hub that follows the infrastructure guidelines laid out by the [Consortium of Infectious Disease Modeling Hubs](https://github.com/hubverse-org/). The example is documented in more detail [here](https://hubverse.io/en/latest/format/intro-data-formats.html#running-examples).
